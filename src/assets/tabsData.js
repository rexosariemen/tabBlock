export const DATA = [
  {
    ...
    image:
      "https://lh3.googleusercontent.com/proxy/5CmjrWTr8Tjve_yV9FQD8bsKawYtuFL3jDl02t0ktgc0XrrcZdnjrz35xpv7uknWLuyT9-S95O6yY49BMeGErEpQDRWp56BzGCSqm3n1yuzVN33z6I5Rxyg2nn6ang",
  },
  {
    name: "SONNET 90",
    text: [
      "Then hate me when thou wilt; if ever, now; Now, while the world is bent my deeds to cross, Join with the spite of fortune, make me bow, And do not drop in for an after-loss: Ah! do not, when my heart hath 'scap'd this sorrow, Come in the rearward of a conquer'd woe;",
      "Give not a windy night a rainy morrow, To linger out a purpos'd overthrow. If thou wilt leave me, do not leave me last, When other petty griefs have done their spite",
    ],
    video:
  ...
  },
  {
    ...
    text: [
      ...
      "Oh, I kept the first for another day! Yet knowing how way leads on to way,I doubted if I should ever come back. I shall be telling this with a sigh Somewhere ages and ages hence: Two roads diverged in a wood, and I took the one less traveled by, And that has made all the difference.",
    ],
  },
  {
    name: "LOREM IPSUM",
